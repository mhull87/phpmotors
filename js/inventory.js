...
classificationList.addEventListener("change", function () {
  let classificationId = classificationList.nodeValue;
  console.log(`classificationId is: ${classificationId}`);
  let classIdURL = "/phpmotors/vehicles.index.php?action=getInventoryItems&classificationId=" + classificationList;
  fetch(classIdURL)
